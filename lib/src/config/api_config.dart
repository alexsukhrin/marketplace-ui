...
class ApiConfig {
  ...
  static String get authUpdatePassword => '$baseUrl/api/v1/auth/update-password';
  ...
  static String get clothingSizes => '$baseUrl/api/v1/products/options/clothing-sizes';
  ...
  static String get paymentOptions => '$baseUrl/api/v1/products/payment-options';
  static String get deliveryOptions => '$baseUrl/api/v1/products/delivery-options';
} 